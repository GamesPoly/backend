...
function AdBanner({ gameAdObj }) {
  return (
    <div className="ad-banner">
      <img
        src={gameAdObj.image}
        alt="Cover this Banner"
        className="ad-banner__image"
      />
      <div className="ad-banner__info">
        <h2 className="ad-banner__title">{gameAdObj.name}</h2>
        <p className="ad-banner__desc">{gameAdObj.desc}</p>
        <div className="ad-banner__tags">
          <p className="ad-banner__ganre">{gameAdObj.ganre}</p>
