...
import banner from '@assets/cover-game18.png'
...
function GameBanner () {
    ...
    const goToPrevSlide = () => {
        setCurrentIndex(currentIndex === 0 ? games.length - 1 : currentIndex - 1); 
    };
    ...
    return (
        <section className={styles["game-banner"]}>
            <div className={styles["game-banner__main"]} style={{ backgroundColor: games[currentIndex].bgColor ,backgroundImage: `url(${games[currentIndex].image})` }}>
                <button className={styles["game-banner__prev"]} onClick={goToPrevSlide}>
                ...
                <button className={styles["game-banner__next"]} onClick={goToNextSlide}>
                    <svg width="23" height="15" viewBox="0 0 23 15"  xmlns="http://www.w3.org/2000/svg " fill="currentcolor">
