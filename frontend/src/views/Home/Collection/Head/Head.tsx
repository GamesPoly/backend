...
const CollectionHead = () => {
    return (
        <div className={styles["collection__head"]}>
            <button className={`${styles["collection__currently"]} ${styles["currently"]}`}>
                <p className={styles["currently__text"]}>Популярное</p>
            ...
            <div className={styles["collection__headline"]}>
                <h2 className={styles["collection__name"]}>Коллекция</h2>
                <div className={styles["collection__action"]}>
                    <button className={`${styles["collection__dot"]} ${["collection__dot--active"]}`}>
                        <p className={styles["visually-hidden"]}>Переключатель 1</p> 
                    </button>
                    <button className={styles["collection__dot"]}>
                        <p className={styles["visually-hidden"]}>Переключатель 2</p> 
                    </button>
                </div>
            </div>
            <button className={`${styles["collection__next-info"]} ${styles["next-info"]}`}>
                <svg className={styles['next-info__arrow']} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                ...
                <p className={styles["next-info__text"]}>О нас</p>
            </button>
        </div>
    );
};
