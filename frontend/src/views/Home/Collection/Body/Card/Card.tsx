...
const CardCollection = ({ version }:any) => {
    return (
        <div>
            { version === 'standart' &&
            <div className={`${styles["collection__card-game"]} ${styles["card-game"]}`}>
                {/* <img src={cover} alt="Cover for game" className="card-game__cover" /> */}
                <svg className={styles["card-game__cover"]} xmlns="http://www.w3.org/2000/svg" width="420" height="220" viewBox="0 0 420 220" fill="none">
                    <mask id="imageMask">
                ...
                <div className={styles["card-game__info"]}>
                    <h3 className={styles["card-game__title"]}>В объективе!</h3>
                    <p className={styles["card-game__desc"]}>Вы - блогер, путешествующий по России. Создавайте впечатляющие фотографии, изучайте новые места для путешествий!</p>
                </div>
                <a href="/" className={styles["card-game__link"]}>
                    <p className={styles["card-game__more"]}>Подробнее</p>
                    <svg className={styles["card-game__arrow"]} xmlns="http://www.w3.org/2000/svg" width="50" height="50" viewBox="0 0 50 50" fill="none">
            ...
            { version === 'solid' &&
            <div className={`${styles["collection__card-game"]} ${styles["card-game"]} ${styles["card-game--solid"]}`} style={{ backgroundImage: `url(${bgCover})` }}>
                <a href="/" className={styles["card-game__author"]}>
                    <img src={avatar} alt="Avatar developer" className={styles["card-game__ava"]} />
                    <div className={styles["card-game__user"]}>
                        <p className={styles["card-game__role"]}>Разработчик</p>
                        <h4 className={styles["card-game__name"]}>IAvocadoI</h4>
                    </div>
                </a>
                <div className={`${styles["card-game__info"]} ${styles["card-game__info--solid"]}`}>
                    <h3 className={styles["card-game__title"]}>Latest Days</h3>
                    <p className={styles["card-game__desc"]}>Это лучший день в твоей жизни. Ни забот, ни печалей. Просто насладись днем у себя дома.</p>
                </div>
                <a href="/" className={`${styles["card-game__link"]} ${styles["card-game__link--solid"]}`}>
                    <p className={styles["card-game__more"]}>Подробнее</p>
                    <svg className={`${styles["card-game__arrow"]} ${styles["card-game__arrow--solid"]}`} xmlns="http://www.w3.org/2000/svg" width="50" height="50" viewBox="0 0 50 50" fill="none">
                        <circle cx="25" cy="25" r="25" fill="#FF5731"/>
                        <path d="M32.4642 18.6363C32.4642 18.0288 31.9717 17.5363 31.3642 17.5363L21.4642 17.5363C20.8566 17.5363 20.3642 18.0288 20.3642 18.6363C20.3642 19.2438 20.8566 19.7363 21.4642 19.7363L30.2642 19.7363L30.2642 28.5363C30.2642 29.1438 30.7566 29.6363 31.3642 29.6363C31.9717 29.6363 32.4642 29.1438 32.4642 28.5363L32.4642 18.6363ZM19.414 32.1421L32.142 19.4142L30.5863 17.8585L17.8584 30.5864L19.414 32.1421Z" fill="white"/>
                    </svg>
                </a>
            ...
            { version === 'mini' &&
            <div className={`${styles["collection__card-game"]} ${styles["card-game"]} ${styles["card-game--mini"]}`}>
                <div className={`${styles["card-game__info"]} ${styles["card-game__info--mini"]}`}>
                    <div className={styles["card-game__head"]}>
                        <div className={styles["card-game__headings"]}>
                            <h3 className={styles["card-game__title"]}>Simulation 23/3</h3>
                            <h5 className={styles["card-game__rating"]}>2 место MospolyJam 2023</h5>
                        </div>
                        <img src={miniCover} alt="Cover for game" className={styles["card-game__squircle"]} />
                    </div>
                    <p className={styles["card-game__desc"]}>Обычный платформер-головоломка, где игроку приходится проходить уровни на логику и смекалку.</p>
                </div>
                <a href="/" className={styles["card-game__link"]}>
                    <p className={styles["card-game__more"]}>Подробнее</p>
                    <svg className={`${styles["card-game__arrow"]} ${styles["card-game__arrow"]}`} xmlns="http://www.w3.org/2000/svg" width="50" height="50" viewBox="0 0 50 50" fill="none">
                        <circle cx="25" cy="25" r="25" fill="#FF5731"/>
                        <path d="M32.4642 18.6363C32.4642 18.0288 31.9717 17.5363 31.3642 17.5363L21.4642 17.5363C20.8566 17.5363 20.3642 18.0288 20.3642 18.6363C20.3642 19.2438 20.8566 19.7363 21.4642 19.7363L30.2642 19.7363L30.2642 28.5363C30.2642 29.1438 30.7566 29.6363 31.3642 29.6363C31.9717 29.6363 32.4642 29.1438 32.4642 28.5363L32.4642 18.6363ZM19.414 32.1421L32.142 19.4142L30.5863 17.8585L17.8584 30.5864L19.414 32.1421Z" fill="white"/>
                    </svg>
                </a>
            ...
            { version === 'catalog' &&
            <div className={`${styles["collection__card-game"]} ${styles["card-game"]} ${styles["card-game--catalog"]}`}>
                <div className={styles["card-game__actions"]}>
                    <a href="#" className={`${styles["card-game__link"]} ${styles["card-game__link--catalog"]}`}>
                        <p className={styles["visually-hidden"]}>Перейти в каталог</p>
                        <svg className={styles["card-game__gamepad"]} xmlns="http://www.w3.org/2000/svg" width="92" height="54" viewBox="0 0 92 54" fill="none">
                    ...
                    <a href="#" className={`${styles["card-game__link"]} ${styles["card-game__link--catalog"]}`}>
                        <img src={arrows} alt="Go to catalog" className={styles["card-game__arrows"]} />
                    </a>
                </div>
                <div className={`${styles["card-game__info"]} ${styles["card-game__info--catalog"]}`}>
                    <p className={styles["card-game__desc"]}>Перейдите в каталог и посмотрите на работы других разработчиков</p>
                </div>
            </div> }
        </div>
    );
