        ...
        <div className={styles['collection__body']}>
            <div className={styles['collection__info']}>
                ...
                <p className={styles['collection__desc']}>
                    Заполните{' '}
                    <span className={styles['collection__desc--highlight']}>
                        форму для отправки проекта
                    </span>
                    , после модерации ваша игра появится в каталоге и будет{' '}
                    <span className="collection__desc--highlight">
                        доступна всем
                    </span>
                </p>
            </div>
