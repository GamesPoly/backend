        ...
        <section className={styles['hero']}>
            <div className={styles['hero__head']}>
                <div className={styles['hero__tools']}>
                    <nav className={styles['hero__navigate navigate']}>
                        ...
                        <ul className={styles['navigate__list']}>
                            <li className={styles['navigate__item']}>
                                <a
                                    href="/"
                                    className={`${styles['navigate__link']} ${styles['navigate__link--active']}`}
                                >
                                    Главная
                                </a>
                            </li>
                    ...
                    <div
                        className={`${styles['hero__last-update']} ${styles['last-update']}`}
                    >
                        <img
                            src={cover}
                            alt=""
                            className={styles['last-update__cover']}
                        />
                        <div className={styles['last-update__details']}>
                            <div className={styles['last-update__info']}>
                                <h3 className={styles['last-update__title']}>
                                    Veles Day
                                </h3>
                                <p className={styles['last-update__desc']}>
                                    upd. 2 час назад
                                </p>
                            </div>
                            <a href="/" className={styles['last-update__link']}>
                                <p className={styles['last-update__open']}>
                                    Открыть
                                </p>
                ...
                <div className={styles['hero__info']}>
                    ...
                    <h1 className={styles['hero__title']}>
                        <span
                            className={`${styles['hero__title']} ${styles['hero__title--highlighted']}`}
                        >
                            продвигай
                        </span>{' '}
                        свои игры
                    ...
                    <div className={styles['hero__details']}>
                        ...
                        <p className={styles['hero__desc']}>
                            Расскажите о{' '}
                            <span
                                className={`${styles['hero__desc']} ${styles['hero__desc--highlighted']}`}
                            >
                                своих проектах
                            </span>
                            ,{' '}
            ...
            <ul className={styles['hero__cards']}>
                <li className={styles['hero__card']}>
                    <div className={styles['hero__ad']}>
                        ...
                        <div className={styles['hero__ad-line']}>
                            <p className={styles['hero__adtext']}>
                                Сотрудничайте
                            </p>
                        </div>
                    </div>
                ...
                <li
                    className={`${styles['hero__card']} ${styles['hero__card--bigger']}`}
                >
                    <img
                        src={photo}
                ...
                <li className={styles['hero__card']}>
                    <img
                        ...
                        className={styles['hero__gamepad']}
                    />
                </li>
                <li className={styles['hero__card']}>
                    <img
                ...
                <li
                    className={`${styles['hero__card']} ${styles['hero__card--higher']}`}
                >
                    <p className={styles['hero__about']}>
                        <span
                            className={`${styles['hero__about']} ${styles['hero__about--highlighted']}`}
                        >
                            Подписывайтесь
                        </span>{' '}
