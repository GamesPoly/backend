...
import styles from "../GameDescription/GameDescription.module.scss"
    ...
    <div className={styles["description"]}>
      ...
      <div className={styles["description__grid"]}>
        <div className={styles["description__column"]}>
          ...
          <img className={styles["description__pic1"]} src={pict1} alt="" />
        </div>
        <div className={styles["description__column"]}>
          <img className={styles["description__pic2"]} src={pict2} alt="" />
          <div className={styles["description__text description__text--second"]}>Есть над чем задуматься: базовые сценарии поведения пользователей набирают популярность
          ...
          <div className={styles["description__text description__text--second"]}>
            <span className={styles["description__title description__title--seconary"]}>Рекомендуемые системные 
          требования</span>
