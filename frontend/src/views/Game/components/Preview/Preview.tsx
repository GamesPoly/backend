...
const Preview: React.FC = () => {
  return (
    ...
    <ul className={styles["preview__list"]}>
        <li>Жанр: <span className={styles["purple-span"]}>Симулятор, Инди, Фэнтези</span></li>
        <li>Разработчик: <span className={styles["purple-span"]} >Little Leo Games</span></li>
        <li>Дата выхода: <span className={styles["purple-span"]}>21 сен. 2023</span></li>
        <li>Размер дистрибутива: <span className={styles["purple-span"]} >1.8 ГБ</span></li>
    </ul>
      </div>
